          ...
          child: Column(
            ...
            children: [
              ...
              HomeUpcomingSection(
                ...
                onEventTap: (event) {
                  final isAutoGenerated = event.id.startsWith('birthday_');
                  if (isAutoGenerated) {
                    final contact = state.contacts.where((c) => c.id == event.contactId).firstOrNull;
                    if (contact != null) {
                      Navigator.push(
                        context,
                    ...
                    showAddEventSheet(context, existingEvent: event);
                  }
                },
              ),
